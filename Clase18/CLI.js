...
//2-En el caso de los productos, poner valores al campo precio entre los 100 y 5000 pesos.
...
//5bi-Listar los productos con precio menor a 1000 pesos.
db.productos.find({ price: { $lt: 1000 } })

//5bii-Listar los productos con precio entre los 1000 a 3000 pesos.
db.productos.find({ $and: [{ price: { $gt: 1000 } }, { price: { $lt: 3000 } }] })

//5biii-Listar los productos con precio mayor a 3000 pesos.
db.productos.find({ price: { $gt: 3000 } })

//5biv-Realizar una consulta que traiga sólo el nombre del tercer producto más barato.
